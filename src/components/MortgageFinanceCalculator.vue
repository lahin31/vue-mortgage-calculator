  ...
  <div class="mortgage_finance_calc calculator">
    ...
    <el-row :gutter="12">
      <el-col :span="12">
        ...
        ></el-input>
        <span
          v-if="errors.has('current_monthly_payment')"
          style="color: red;"
        >Current loan interest rate field is required</span>
      </el-col>
      <el-col :span="12">
        ...
        ></el-input>
        <span
          v-if="errors.has('current_loan_interest_rate')"
          style="color: red;"
        >Current loan interest rate field is required</span>
      </el-col>
    </el-row>
    <el-row :gutter="12">
      <el-col :span="12">
        ...
        ></el-input>
        <span v-if="errors.has('balance')" style="color: red;">Balance field is required</span>
      </el-col>
      <el-col :span="12">
        ...
        ></el-input>
        <span
          v-if="errors.has('new_interest_rate')"
          style="color: red;"
        >New interest rate field is required</span>
      </el-col>
    </el-row>
    <el-row :gutter="12">
      <el-col :span="12">
        ...
        ></el-input>
        <span
          v-if="errors.has('remaining_loan_term')"
          style="color: red;"
        >Remaining loan term field is required</span>
      </el-col>
      <el-col :span="12">
        ...
        ></el-input>
        <span v-if="errors.has('new_loan_term')" style="color: red;">New loan term field is required</span>
      </el-col>
    </el-row>

    <div>
      <p>
        <strong>How much will it cost you?</strong>
      </p>
    </div>
    ...
    <el-row :gutter="12">
      <el-col :span="12">
        ...
        <el-input
          ...
          v-validate="'required'"
        ></el-input>
        <span v-if="errors.has('points')" style="color: red;">Points field is required</span>
      </el-col>
...
export default {
  ...
  created() {
    ...
    this.monthly_payment = parseFloat(
      (this.balance * interest_rate) /
        (1 - 1 / Math.pow(1 + interest_rate, new_loan_term_mnt))
    );
  ...
  watch: {
    current_monthly_payment() {
      if (this.new_interest_rate != 0) {
        this.new_interest_rate_upd = parseFloat(
          this.new_interest_rate / 12 / 100
        );
      }
      ...
      if (this.monthly_payment != 0 && this.current_monthly_payment != 0) {
        this.monthly_savings = parseFloat(
          this.current_monthly_payment - this.monthly_payment
        );
    ...
    balance() {
      ...
      if (this.balance != 0 && this.new_interest_rate_upd != 0) {
        this.monthly_payment = parseFloat(
          (this.balance * this.new_interest_rate_upd) /
            (1 -
              1 /
                Math.pow(
                  1 + this.new_interest_rate_upd,
                  this.new_loan_term_upd
                ))
        );
    ...
    new_interest_rate() {
      ...
      if (
        this.balance != 0 &&
        this.new_interest_rate_upd != 0 &&
        this.new_loan_term_upd != 0
      ) {
        this.monthly_payment = parseFloat(
          (this.balance * this.new_interest_rate_upd) /
            (1 -
  ...
  computed: {
    ...
    diff_in_interest() {
      if (
        this.current_monthly_payment != 0 &&
        this.balance != 0 &&
        this.remaining_loan_term != 0 &&
        this.new_loan_term != 0 &&
        this.monthly_payment != 0
      ) {
        var old_interest_rate =
          this.current_monthly_payment * (this.remaining_loan_term * 12) -
          this.balance;
        var new_interest_rate =
          this.monthly_payment * (this.new_loan_term * 12) - this.balance;
